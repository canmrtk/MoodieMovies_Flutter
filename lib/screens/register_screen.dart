...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // LEFT section: promo
  Widget _buildLeft({required bool isWide}) {
    return Padding(
      padding: isWide
      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Image.asset('assets/afisler.jpg', fit: BoxFit.cover),
          ),
        ],
      ),
    );
                ...
                onPressed: _loading
                    ...
                    : () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          try {
                            final success = await auth.register(email: _email, password: _password, username: _username);
                            setState(() => _loading = false);
                            if (success) {
                              if (!mounted) return;
                              showSuccess(context, 'Kayıt başarılı');
